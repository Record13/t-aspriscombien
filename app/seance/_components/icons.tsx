...
export const Copy = ({ size = 16, color = 'currentColor', stroke = 2.4 }: IconProps) => (
...
export const ArrowUpRight = ({ size = 16, color = 'currentColor', stroke = 2.6 }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" aria-hidden>
    <path d="M7 17L17 7M9 7h8v8" stroke={color} strokeWidth={stroke} strokeLinecap="round" strokeLinejoin="round" />
  </svg>
)

export const Flame = ({ size = 16, color = 'currentColor', stroke = 2.2 }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" aria-hidden>
    <path
...
export const Timer = ({ size = 16, color = 'currentColor', stroke = 2.2 }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" aria-hidden>
    <circle cx="12" cy="13" r="8" stroke={color} strokeWidth={stroke} />
    <path d="M12 9v4l2.5 2M9 2h6M12 2v2" stroke={color} strokeWidth={stroke} strokeLinecap="round" />
  </svg>
)

export const Dumbbell = ({ size = 16, color = 'currentColor', stroke = 2.2 }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" aria-hidden>
    <path d="M3 9v6M6 7v10M18 7v10M21 9v6M6 12h12" stroke={color} strokeWidth={stroke} strokeLinecap="round" />
  </svg>
)

export const TrendUp = ({ size = 16, color = 'currentColor', stroke = 2.2 }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" aria-hidden>
    <path d="M3 17l6-6 4 4 7-8M14 7h6v6" stroke={color} strokeWidth={stroke} strokeLinecap="round" strokeLinejoin="round" />
  </svg>
)

export const Settings = ({ size = 16, color = 'currentColor', stroke = 2 }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" aria-hidden>
...
export const X = ({ size = 16, color = 'currentColor', stroke = 2.6 }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" aria-hidden>
    <path d="M6 6l12 12M18 6L6 18" stroke={color} strokeWidth={stroke} strokeLinecap="round" />
  </svg>
)

export const Trash = ({ size = 16, color = 'currentColor', stroke = 2.4 }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" aria-hidden>
    <path
...
export const Search = ({ size = 16, color = 'currentColor', stroke = 2.4 }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" aria-hidden>
